...
\subsection{If I write an application which uses OTB am I forced to distribute that application?}
...
\subsection{If I wanted to distribute an application which uses OTB what license would I need to use?}
    The CeCILL licence.
