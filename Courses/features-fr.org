...
***** Point 3
Le gradient recursif utilise un lissage gaussien (filtrage passe-bas)
...
***** Point 4
Les seuils haut et bas definissent les intervalles de valeurs qui
...
L'intérêr d'avoir des paramètres est que l'on peut prendre en compte
...
calculer la lingueur dans cette direction. Un faible valeur de ce
...
- Le parmaètre /quant. levels/ détermine le nombre de valeurs qui
