#+TITLE: OGRS2012 : Exploit Pleiades PHR data with the ORFEO ToolBox
...
**** Estimate image statistics
     ...
     - Use the *ComputeImagesStatistics* to compute statistics on
       /melbourne_ms_toa_ortho_extract_small.tif/ image
...
**** Improvement of epipolar geometry
     ...
     ~tristereo_melbourne_1_small_ref.tif and tristereo_melbourne_2_small_ref.tif~

     1. Recompute epipolar geometry with the new stereo pair (post-fix
        /_ref.tif/). Open the 2 versions of epipolar couples (total of
        4 images). What differences do you notice between the two
        images pair?
