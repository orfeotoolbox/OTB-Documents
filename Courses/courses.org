...
**** Apply classification model
     ...
     - Bonus : Use the same model to apply the classification to the other extract \textit{melbourne_ms_toa_ortho_extract_large.tif}
...
**** Item3
     : $ otb_path/otbcli_BandMath 
     : -il $results/${case}_disparity_map_$1_$2.tif  
