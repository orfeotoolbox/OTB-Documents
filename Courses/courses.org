...
#+LATEX:\fancyfoot[C]{\vspace{3pt}\footnotesize{This content is provided under a Creative Commons Attribution 3.0 Unported License
}\includegraphics[height=5pt]{Images/CC-licence.png}}
* Foreword                                                               :fw:
** About the data
