...
**** Pre-requisites
     ...
     - Basic knowledge on OTB applications and QGis usage
     - Basic knowledge on stereoscopic reconstruction

**** Achievements

     - Usage of set of stereoscopic reconstruction applications
     - Stereo reconstruction on Pleiades images

*** Steps

**** From image to epipolar geometry
...
**** Homework
     ...
     2. Re-compute disparity maps using sub-pixel block matching and  median filter to "boucher les trous"
     3. 
* Solutions

** Solution 1: Discover Monteverdi and OTB-Applications
