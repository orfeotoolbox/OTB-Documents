...
** Pre-processing : geometry and radiometry corrections
*** Description
**** Abstract
...
**** Geometric corrections principle
     TODO explain sensor model and coordinate transformation
     #+BEGIN_LaTeX
     \begin{center}
...
%\pause
     ...
     2. Which parameters allow to manange Digital Elevation Model informations (DEM)? Which modes are available?
     3. Open the image with Monteverdi, what is the estimated
**** Simple orthorectification
     1. In which UTM zone, what is the UTM zone for Melbourne?
     2. Perform the orthorectification of the image?
...
#+END_LaTeX 
   ...
   _Tips and Recommandations:_
      - Enable the '-milli' parameter which allow to save the output image in uint16
