...
**** Luminance
     Luminance is the quantative measure of lights (W.m-2.sr-1)
...
**** What is pansharpening ?
    - Most VHR sensors acquired 2 images separately:
      - The multi-spectral bands cover a narrow  range with less spatial
        resolution (than PAN)
      - The panchromatique band with a larger spectral range and a greater
...
*** Description                                                        :desc:
**** Summary
     This exercise allows to get familiar qwith radiometric and geometric
