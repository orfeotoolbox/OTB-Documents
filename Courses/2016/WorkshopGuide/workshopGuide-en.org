...
*** Data folder
    ...
    Sub-folder used during the training session is defined in the outline of each exercise. 
...
*** Guide folder 
    It contains all the support/documentation to complete exercises:
    - Guide for exercises
    - Slides
    - Installation guide
...
- Landsat-8 :: Several dates concatenate, cloud-free (gap-filling) with
               ...
               Shapefile provided by [[http://www.cesbio.ups-tlse.fr/][CESBIO]] (for the classification exercise TP classification),
...
- Sentinel-1 :: Single Look Complex (SLC) product - Strip Map (SM),
...
- Pléiades :: [[http://professionnels.ign.fr/images-pleiades][access facilitate for French Institute]] 
