...
de chaine de traitements d'images en utilisant les applications OTB,
incluant entre autre:
...
| 31.03 | 10:40 - 13:40 | TP1: Généralités        |
|-------+---------------+-------------------------|
| 31.03 | 13:40 - 15:10 | Pause déjeuner          |
|-------+---------------+-------------------------|
| 31.03 | 15:10 - 16:10 | TP2: Prétraitements THR |
...
*** Répertoire Data
    ...
    des sous-répertoire séparés. Le sous-répertoire nécessaire est
...
Pour obtenir d'autres données issues de ces capteurs:
...
- Sentinel-1 :: Données gratuites disponible sur le [[https://scihub.copernicus.eu/][Hub ESA]] ou sur le site CNES [[https://peps.cnes.fr][PEPS]]
