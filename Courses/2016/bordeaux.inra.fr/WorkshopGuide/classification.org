...
**** Présentation des données LANDSAT 8
    ...
    Les fichiers ~Data/classification/training/training.shp~ et
    ~Data/classification/testing/testing.shp~ contiennent des
...
**** Classification multidate
     ...
     très bonne: on va maintenant essayer d'améliorer la
  ...
  spectrales supplémentaire. Avec les données LANDSAT 8, il s'agit
  ...
  d'intégrer les variation saisonales qui apporte beaucoup
...
**** Post-traitements de la classification
  ...
  - ip.suvbool 0 :: Que faire lors d'une égalité. 0 pour utiliser la valeur
  existante.

  Filtrez le resultat de la classification précédente (neuf dates et
  profil NDVI) puis comparer les resultats avec les images RGB (dans
...
*** Classification d'une date
    ...
    -il ${LS8DATA}/Extract16bit/LANDSAT_MultiTempIm_clip_GapF_20141026.tif \
    ...
    -io.il ${LS8DATA}/Extract16bit/LANDSAT_MultiTempIm_clip_GapF_20141026.tif \
    ...
    -in ${LS8DATA}/Extract16bit/LANDSAT_MultiTempIm_clip_GapF_20141026.tif \
    ...
    carte colorisée en fonction de la classe attribuée:
...
*** Classification multidate
    ...
    ${LS8DATA}/Extract16bit/LANDSAT_MultiTempIm_clip_GapF_20140309.tif \
    ${LS8DATA}/Extract16bit/LANDSAT_MultiTempIm_clip_GapF_20140401.tif \
    ${LS8DATA}/Extract16bit/LANDSAT_MultiTempIm_clip_GapF_20140417.tif \
    ${LS8DATA}/Extract16bit/LANDSAT_MultiTempIm_clip_GapF_20140528.tif \
    ${LS8DATA}/Extract16bit/LANDSAT_MultiTempIm_clip_GapF_20140620.tif \
    ${LS8DATA}/Extract16bit/LANDSAT_MultiTempIm_clip_GapF_20140731.tif \
    ${LS8DATA}/Extract16bit/LANDSAT_MultiTempIm_clip_GapF_20140901.tif \
    ${LS8DATA}/Extract16bit/LANDSAT_MultiTempIm_clip_GapF_20141003.tif \
    ${LS8DATA}/Extract16bit/LANDSAT_MultiTempIm_clip_GapF_20141026.tif \
...
*** Calcul d'un profil de NDVI
    ...
    -in ${LS8DATA}/Extract16bit/LANDSAT_MultiTempIm_clip_GapF_${date}.tif \
    -out ${date}-ndvi.tif \
...
*** Classification du profil de NDVI
    ...
    Pour la classification, on rajoute également les bandes spectrales intiales pour toutes les dates:
...
*** Post-traitements de la classification
    ...
    On peut ensuite rejouter les étapes de colorisation et de validation:
