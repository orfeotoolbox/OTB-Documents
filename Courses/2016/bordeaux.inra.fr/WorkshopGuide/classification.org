...
***** Régularisation
  ...
  Filtrez le resultat de la classification précédente (neuf dates et profil
  NDVI) puis comparer les resultats avec les images RGB (dans monteverdi) et
  avec les matrices de confusions (avec un
  tableur).
