...
**** Documents (forme électronique)
     - Documentation de l'Orfe ToolBox (Software Guide, Cookbook)
     - Guide de TP
     - Planches (cette présentation)
     - Solutions (distribuées à la fin)
**** Données (spécifique à chaque TP)
     LandSat8, Pléiades, Sentinel1, SRTM, Ad hoc ...
**** Logiciels
