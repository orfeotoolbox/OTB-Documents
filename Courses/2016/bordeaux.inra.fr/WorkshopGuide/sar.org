...
**** Polarimétrie
     ...
     5. Jouons un peu pour finir à "Où est Charlie?". A partir de la
        composition colorée en décibels:
        - Indiquer les coordonnées de 2 lignes électrique parallèles visible dans l'image?
...
**** Polarimétrie
     ...
     3. Analyse de la composition colorée:
        ...
        - Plot métalliques pour amarrer les bateaux 
