...
*** Calibration radiométrie
    ...
    - Comme pour l'optique, la calibration permet de transformer des CN en
      grandeur physique
    - Permet d'intercomparer des images radars provenant de capteurs différents
...
*** Speckle
    ...
    - Atténuer ce bruit en convervant le maximum de détails
    - Filtrage permet d'améliorer enormément la qualité des images et leur interprétation
