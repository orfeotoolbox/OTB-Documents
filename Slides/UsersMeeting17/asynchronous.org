...
#+latex_header: \subtitle{Plans for assynchronous s/writing/I\/O/}

* Introduction
** What assynchronous means
...
** The easy part: writing
   ...
   - Making this call assynchronous with a FIFO and a separate writing
...
** C++11 to the rescue ?
   ...
   The tricky part is that our objects are not sateless 
