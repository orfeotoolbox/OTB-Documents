...
\begin{block}{Un club de développeurs, pas de décideurs}
  \begin{itemize}
  \item Pilotage haut niveau du projet, roadmaps, communication, plannification
...
\begin{frame}
\frametitle{5.4 (Mai 2016) Nouveau framework d'échantillonnage}
\begin{block}{Principe}
\begin{itemize}
\item Un nouveau module d'échantillonage pour l'apprentissage supervisé
\item Selection et extraction d'échantillons avec différentes méthodes:
  aléatoire, périodique, \ldots
\end{itemize}
\end{block}
