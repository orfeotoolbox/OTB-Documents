...
\vspace{-0.2cm}
\begin{description}
\item[Où se trouve le code?] \href{https://gitlab.orfeo-toolbox.org/}{gitlab.orfeo-toolbox.org}
\item[Vous avez trouvé un bug?] \href{https://gitlab.orfeo-toolbox.org/orfeotoolbox/otb/issues}{gitlab.orfeo-toolbox.org/orfeotoolbox/otb/issues}
