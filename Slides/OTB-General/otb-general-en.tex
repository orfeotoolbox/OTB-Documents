...
%\vspace*{-3.0mm}
\begin{frame}
  \frametitle{QGIS (\textbf{Added support to OTB 5.6 during the code sprint)}}
\begin{minipage}[t][6cm][t]{\textwidth}
\begin{center}
...
\item Open Sentinel-1 image (SLC product)
\end{itemize}
\end{block}
\end{frame}
...
\begin{frame}
\frametitle{Polygons sampling strategy}
\begin{minipage}[t][6cm][t]{\textwidth}
\begin{center}
