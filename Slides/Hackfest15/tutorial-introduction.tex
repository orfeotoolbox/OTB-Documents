...
%	PAGE TITRE
%----------------------------------------------------------------------------------------
\title{Orfeo ToolBox users meeting and hackfest 2015: Tutorials}
...
\item Writing a new application
\end{itemize} 
\end{block}
...
\item Gradual tutorial covering applications 
\item We can provide a virtual machine with everything installed
\end{itemize} 
\end{block}
