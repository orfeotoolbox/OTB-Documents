...
- Starts right after source archives are published.
- Check if any of our dependencies are messed up in official
  repository. (OSGeo4W, ubuntuGIS, Fedora, EPEL, MacPorts, Homebrew (Mac OS X))
...
- This has become a /sad/ but important work taking out 2-3 week developer time!
...
* So we need a package that...
  - .. works on Linux (all distros), Windows, Mac OSX.
  ...
  - .. does not distract developer crowd from fixing critical bugs to adding cool features and documentation!
