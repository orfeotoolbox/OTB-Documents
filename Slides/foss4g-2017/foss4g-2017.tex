...
\subtitle{FOSS4G 2017}
\usetheme{default}
\author{Manuel Grizonnet}
\date{2017-07-19}
\title{ORFEO ToolBox license change from CeCILL to Apache : diary of a long journey}
\hypersetup{
  pdfkeywords={otb},
  pdfsubject={},
...
\item Accessible from C++, Bash, GUI, Python, QGIS, Monteverdi, WPS (Zoo)
...
\item \textbf{Big Data} capable, thanks to built-in streaming, multithreading
    and MPI
\item Apache v2.0 license (since release 6.0) before CeCILL v2
...
\item \alert{An OSGeo project since July 2017!}
\end{itemize}
