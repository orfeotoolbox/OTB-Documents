...
\section{Make OTB better in QGIS!}
...
\item Development took a turn due to some *non-technical*/politic issues in qgis and otb
...
\item First version is distributed a plugin
\item Plugin repository is \href{https://gitlab.orfeo-toolbox.org/orfeotoolbox/qgis-otb-plugin}{https://gitlab.orfeo-toolbox.org/orfeotoolbox/qgis-otb-plugin}
\end{itemize}
\end{frame}
