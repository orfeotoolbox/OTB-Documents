...
\begin{frame}
  ...
  \begin{block}{OSGeo incubation}
    \begin{itemize}
      \item Processus formel pour intégrer de nouveaux logiciels ``labellisés'' OSGeo
      \item Incubation de l'OTB a débuté en 2011
      \item Long voyage semé d'embûche...
    \end{itemize}
  \end{block}
  \begin{center}
  ...
  \begin{block}{L'âge de la maturité}
    \begin{itemize}
      ...
      \item Processus qui a aidé l'OTB a ``grandir''
...
\begin{itemize}
    ...
    \item $\approx$ 2000 téléchargements par mois pour l'installeur OTB (Windows64)
  \end{itemize}
\end{block}
...
\begin{frame}
  \frametitle{Journée Utilisateur OTB 2018 - Montpellier - 19/10/2018}
  \begin{description}
  ...
  \item[Quoi?] Présentations, Retour d'expérience, Formations, tutos...
  \item[Comment?] Gratuit, ouvert à tous et à toutes...
  \item[Je m'inscris!] \href{https://tinyurl.com/y7yzjvad}{https://tinyurl.com/y7yzjvad}
  \end{description}
  \begin{center}
