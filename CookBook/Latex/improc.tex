...
\label{ssec:classificationcolormappingexample}
...
\begin{figure}[!h]
  ...
  \itkcaption[ExampleSVMClassifCMR]{From left to right: Original image, fancy colored classified image and regularized classification map with radius equal to 2 pixels.}
