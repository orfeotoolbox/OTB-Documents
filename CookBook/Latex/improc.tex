...
The aim of tyhis application is to Epipolar geometry is the geometry of stereo vision.
...
otbcli_StereoRectificationGridGenerator -io.inleft left.tif
                                        ...
                                        -epi.step 10
                                        -io.outleft outleft_pyramid.tif
                                        -io.outright outright_pyramid.tif
\end{verbatim}
...
Resample both images into epipolar geometry using those grids
