...
This transformation can be done either with an application or with
...
Using either an application or modules from \mont, it is
...
\subsubsection{Ortho-rectification with applications}
