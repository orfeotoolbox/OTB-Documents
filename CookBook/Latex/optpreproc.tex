...
\begin{itemize}
\item Open panchromatic and multispectral images in monteverdi using the \module{Open Dataset} module or using the  $-iml$ option of the \mont executable.

\item The \module{Superimpose} module is used to zoomed and registered
...
\item Now the \module{Simple RCS pan-sharpening} module can be used using the panchromatic and the multispectral images as inputs. It produces a multispectral image with the same resolution and geographic extension %(cf ~\ref{fig:pansharpen}).

% \begin{figure}
%%   \center
%%   \includegraphics[width=0.6\textwidth]{../Art/MonteverdiImages/monteverdi_QB_MUL_Pan_sharpened.png}
%%   \itkcaption[Pan-sharpened image]{Pan-sharpened image using the simple RCS pan-sharpening module.}
