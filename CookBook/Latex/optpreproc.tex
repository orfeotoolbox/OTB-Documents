...
\subsubsection{Optical calibration application}
...
\subsubsection{Pan-sharpening with an application}
...
\begin{verbatim}
otbcli_OrthoRectification -io.in input_image -io.out output_image -elev dem
...
otbcli_OrthoRectification -io.in input_image -io.out output_image -elev dem
-elev.dem.path dem_dir -map lambert93
...
\begin{itemize}
\item UTM : \begin{verbatim}-map utm\end{verbatim}
The UTM zone and hemisphere can be set by the options \verb?-map.utm.zone? and \verb?-map.utm.northhem?.
\item Lambert 2 etendu: \begin{verbatim}-map lambert2\end{verbatim}
\item Lambert 93: \begin{verbatim}-map lambert93\end{verbatim}
\item TransMercator: \begin{verbatim}-map transmercator\end{verbatim}
...
\item WGS : \begin{verbatim}-map wgs\end{verbatim}
\item Any map projection system with an EPSG code : \begin{verbatim}-map epsg\end{verbatim}
...
otbcli_OrthoRectification -io.in input_image -io.out output_image -elev dem
-elev.dem.path dem_dir -map lambert93 -outputs.spacingx spx -outputs.spacingy spy
...
otbcli_OrthoRectification -io.in input_image -io.out output_image 
-elev dem -elev.dem.path dem_dir -map lambert93 
-outputs.spacingx spx -outputs.spacingy spy 
-outputs.ulx ul_x_coord -outputs.uly ul_y_coord 
-outputs.sizex x_size -outputs.sizey y_size
