...
measurement space. For reciprocal targets where HV = VH, this space is 
compressed to five dimensions: three amplitudes (|HH|, |HV|, and |VV|); 
and two phase measurements, (co-pol: HH-VV, and cross-pol: HH-HV).
\todo ref to http://www.grss-ieee.org/technical-briefs/imaging-radar-polarimetry
...
measurement is a 2×2 complex scattering matrix yielding an eight dimensional 
measurement space. Two other measurements, which are also important in polarimetry, 
are the covariance matrix and the Mueller matrix. These are the basis for most analyses. 
This part of \mont allows to change a measurement to another.
