...
\chapter*{Foreword}
\noindent
After almost 5 years of development, the Orfeo ToolBox has become a
...
giving access to its functionalities to non-developpers.

Meanwhile, the \textbf{Orfeo ToolBox Software Guide} has grown to more
than 700 pages of documented code examples, which, combined with the
class documentation with doxygen, allows to developer users to find
their way through the Orfeo ToolBox so as to write code suiting their
needs.

Yet, the documentation available for non-developpers users, using
...
ToolBox: Monteverdi, and the OTB-Applications. 



A general introduction of these two software is first presented, along
...
either Monteverdi, OTB-Applications or both.
