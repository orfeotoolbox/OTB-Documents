...
\newcommand{\mmod}[1]{\emph{#1}\xspace}
\newcommand{\application}[1]{\emph{#1}\xspace}
\newcommand{\sg}{\href{http://orfeo-toolbox.org/SoftwareGuide/}{OTB Software Guide}\space}
...
class documentation with the \dox, allows to developer users to find
