...
The statistics file format is identic to the output file from \application{ComputeImagesStatistics}
...
\application{TrainImagesClassifier}. From the input dataset, a portion of the samples
...
of \application{PredictRegression} with respect to statistic file is identic to
