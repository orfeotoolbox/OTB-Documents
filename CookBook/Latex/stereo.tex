...
rectification determines transformations to apply of each image such that pairs of
...
intermediary result not really useful as it in most cases. This second
...
We obtain two images in epipolar geometry\ref{fig:EpipolarImages}.
