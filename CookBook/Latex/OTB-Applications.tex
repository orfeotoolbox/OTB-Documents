...
\begin{itemize}
\item for Windows platform (Seven and later) using MinGW cross-compilation (32/64bit)
\item for Linux 64bit distribution
\item for MacOSX
\end{itemize}
...
We provide OTB Applications for Windows Seven and later through standalone packages.
...
\subsection{Linux 64bit OS}

We provide OTB Applications for Linux 64bit OS through standalone packages.
They contain all OTB Applications and their launchers (both command line and graphical
launchers are provided). Check the download page :
\href{https://www.orfeo-toolbox.org/download}{OTB Download page}

This package consist in a self-extractible archive.
...
\item A \textbf{lib} folder containing all shared libraries and application DLLs.
\end{itemize}
...
Soon ...
% TODO : description of MacOSX standalone package
