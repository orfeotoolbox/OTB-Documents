...
\begin{abstract}
Many high level techniques to analyse very high resolution remote
...
functions\furl{http://www.gdal.org/ogr/}. This abstraction layer
allows our tool to address simple file formats like ESRI Shapefile and
Sqlite or complex databases like PostGIS seamlessly.
...
The ITK library on top of which OTB is built proposes many
...
For this purpose, in addition to the watershed algorithm available in
ITK, we implemented in Orfeo ToolBox a simple connected-component
algorithm with a user defined criterion, the Mean-Shift
algorithm~\cite{comaniciu2002mean}, and the morphological segmentation
described in~\cite{pesaresi2001new}. Figure~\ref{fig:segalgs} shows
the result of three different algorithms from Orfeo ToolBox applied to
a Pleiades image patch.

\begin{figure}[!htb]
\centering
\subfigure[Watershed]{\includegraphics[width=0.26\textwidth]{Pictures/watershed_color_optimal}}
\qquad
\subfigure[Mean-Shift]{\includegraphics[width=0.26\textwidth]{Pictures/meanshift_color_optimal}}
\qquad
\subfigure[Morphological Profiles]{\includegraphics[width=0.26\textwidth]{Pictures/geomorpho_color_optimal}}\\

\subfigure[Watershed]{\includegraphics[width=0.26\textwidth]{Pictures/watershed_color_image}}
\qquad
\subfigure[Mean-Shift]{\includegraphics[width=0.26\textwidth]{Pictures/meanshift_color_image}}
\qquad
\subfigure[Morphological Profiles]{\includegraphics[width=0.26\textwidth]{Pictures/geomorpho_color_image}}
...
assumptions. The different algorithms do not need to share the same set
